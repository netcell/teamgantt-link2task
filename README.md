...
$('.task[task_id]').not('.super_quick_add')
		.each(function() {
			...
			prevLink.remove();
			el.prepend('<a class="get_url" href="https://www.teamgantt.com/gantt/schedule/?onload=highlight-task,'+id+'&ids=710003#&ids=710003&" style="position:absolute; left: 0;">Link</a>')
		})
```
